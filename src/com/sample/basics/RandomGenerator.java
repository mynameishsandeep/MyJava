...
public class RandomGenerator {
	public void generateUsingTimeStamp() {
		...
		System.out.println("using systemCurrentTime "+System.currentTimeMillis() % 2); // Generates 0 or 1
	...
	public void generateUsingRandom() {
		...
		Random r = new Random(12);	System.out.println(r.nextInt());// Generates 0 or 1
