 ...
 */
public class PartitionToKEqualSumSubsets_BackTrack {
  public static void main(String[] args) {
    PartitionToKEqualSumSubsets_BackTrack p = new PartitionToKEqualSumSubsets_BackTrack();
  ...
  public boolean canPartition(
      int[] nums, boolean[] visited, int startIndex, int k, int currentSum, int target) {
    ...
    return false; // (currentSum > target)
  }
}
