...
public class PowerNProblem {
  ...
  public static double powerNBestApproach(double base, int n) {
    ...
    // initially 2*2=4, then 4*4=16, then 16*16=256,  then 256*256=65536
    double baseSquare = base * base;
    System.out.println("baseSquare " + baseSquare);
    if (n % 2 == 0) return powerNBestApproach(baseSquare, n / 2) * 1;
    return powerNBestApproach(baseSquare, n / 2) * base;
  }
