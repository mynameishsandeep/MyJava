 ...
 * =====Solution Note===========================
 * This data structure is like onion. Nothing will be saved in array index. meaning position of index
 * for a character saves next node.
...
public class Trie_Array {
  ...
  public static void main(String[] args) {
    ...
    trie.insert("had");
    trie.insert("hada");
    System.out.println(trie.search("had"));
