...
public class Graph_DepthFirstSearch {
	public static void updateAdjMatrixMap(Map<Integer, List<Integer>> adjMatrixMap, int nodeFrom, int nodeTo) {
	...
	public static void doDFS(Map<Integer, List<Integer>> adjMatrixMap, int rootNode, boolean isVisited[]) {
