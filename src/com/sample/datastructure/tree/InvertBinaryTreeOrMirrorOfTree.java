 ...
 *  ================================
 *  =====Solution Note:=====
 *  Return parent, when child is not null. So that parent can swap left and right child.
 *  The swap will skip, if both left and right is null.
 *  =================
 *  
 *  ==== For a 7 node(balanced)... Swap method will be called 7 times.
 *  But swap will happen 3 times, skipping 4 leaf nodes.==========
 */
